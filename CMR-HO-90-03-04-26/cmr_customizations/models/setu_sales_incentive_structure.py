...
class SetuSalesIncentiveStructure(models.Model):
    ...
    warehouse_ids = fields.Many2many(comodel_name='stock.warehouse', string='Stores',
    ...
    nhcl_incentive_type = fields.Selection([('regular', 'Regular'), ('target', 'Target'), ('product_aging','Product Aging'), ('days_aging','Days Aging'), ('store_target','Store Target')], string="Incentive Type",)
    nhcl_company_type = fields.Selection([('gross','Global'), ('site_wise','Site Wise')], string="Company Type")
