        ...
        for picking in self:
            ...
            for v in picking.stock_verification_ids:
                ...
                if serial in unbrand_serials:
                    ...
                    brand_verified_serial_counter[serial] += 1
            ...
            if picking.picking_type_id.code == 'incoming' and (picking.stock_type in ['ho_operation','direct_po','sub_contract','data_import'] or is_subcontract):
                ...
                if move_lines:
                    ...
                    if (not picking.is_confirm and un_move_lines) or (
                        ...
                        if res and picking.purchase_id and picking.is_landed_cost == 'no' and picking.stock_type in ['ho_operation','direct_po','sub_contract','data_import']:
                        ...
                        if res and picking.is_landed_cost == 'no' and picking.stock_type in ['data_import']:
                            for move_line in picking.move_ids_without_package.move_line_ids:
                                ...
                                lot_id = move_line.lot_id
                                lot_id.write({
                                    'actual_cp': move_line.acutal_line_cp,
                                    'cost_price': move_line.cost_price,
                                })
                                lot_id._get_product_aging()
