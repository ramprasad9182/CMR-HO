...
class Picking(models.Model):
    ...
    def button_validate(self):
        ...
        for picking in self:
            ...
            if picking.picking_type_id.code == 'incoming' and (picking.stock_type in ['ho_operation','direct_po','sub_contract','data_import'] or is_subcontract):
                ...
                if move_lines:
                    ...
                    if (not picking.is_confirm and un_move_lines) or (
                        ...
                        if res and picking.is_landed_cost == 'no' and picking.stock_type in ['data_import']:
                            for move_line in picking.move_ids_without_package.move_line_ids:
                                move_line.lot_values_update()
                                lot_id = move_line.lot_id
