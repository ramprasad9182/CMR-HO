...
class HrPayslip(models.Model):
    ...
    emp_code = fields.Char(string="EMP CODE", related="employee_id.barcode", store=True, readonly=True)
    ...
    basic_salary = fields.Float(string="BASIC", compute="_compute_all_salary_components", readonly=False,compute_sudo=True)
    hra = fields.Float(string="HRA", compute="_compute_all_salary_components",  readonly=False,compute_sudo=True)
    bonus = fields.Float(string="BONUS", compute="_compute_all_salary_components", readonly=False,compute_sudo=True)
    earned_gross = fields.Float(string="Earned Gross", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    total_earnings = fields.Float(string="Total Earnings", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    mng_deduction = fields.Float(string="MNG DED", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    pf_er = fields.Float(string="PF ER", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    esi = fields.Float(string="ESI", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    ...
    total_deduction = fields.Float(string="Total Deductions", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    arrear_days = fields.Float(string="Arrear Days", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    arrear_amt = fields.Float(string="Arrear Amt", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    net_pay = fields.Float(string="Net Pay", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    total_bonus_amt = fields.Float(string="Total Bonus Amount", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    payable_amt = fields.Float(string="Payable Amount", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    absent_amount = fields.Float(string="Absent Amount", compute="_compute_all_salary_components", readonly=True,compute_sudo=True)
    ...
    lop_work_entry_count = fields.Float(
        string="LOP Work Entry Count",
        compute="_compute_lop_work_entry_count",
        store=True,
        digits=(16, 2),
    ...
    emp_company_id = fields.Many2one(string="Employee Company", related="employee_id.company_id", store=True, readonly=True)
