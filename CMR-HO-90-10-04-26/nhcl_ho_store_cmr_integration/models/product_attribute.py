...
class ProductAttribute(models.Model):
    ...
    def get_stores_data(self):
        for store in self:
            ...
            no_ip_lines = store.product_attribute_replication_id.filtered(
                lambda x: x.nhcl_terminal_ip not in ho_store_id.mapped('nhcl_terminal_ip'))
            no_api_lines = store.product_attribute_replication_id.filtered(
            ...
            if no_ip_lines:
                ...
                no_api_lines.unlink()
            existing_store_ids = []
            if store.product_attribute_replication_id:
...
class ProductAttributeReplication(models.Model):
    ...
    _description = "Product Attribute Replication"
...
class dev_transport_details_line(models.Model):
    ...
    _description = "Dev Transport Detials Replication"
...
class routes_details_line(models.Model):
    ...
    _description = "Dev Routes Details Replication"
...
class location_location_line(models.Model):
    ...
    _description = "Dev Location Replication"
