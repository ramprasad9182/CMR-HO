...
class GETJournals(http.Controller):
    ...
    def get_customer_vendor_invoice_journal_entries(self, **kwargs):
        ...
        data = request.env['account.move'].sudo().search([('move_type', '=', 'in_invoice'),('move_type', '=', 'out_invoice'),('nhcl_flag', '=', 'n'),('state', '=','posted')])
    ...
    def get_updated_customer_vendor_invoice_journal_entries(self, **kwargs):
        ...
        # Fetch journal entries based on the provided date
        data = request.env['account.move'].sudo().search([('move_type', '=', 'in_invoice'),('move_type', '=', 'out_invoice'),('update_flag', '=', 'update'),('state', '=','posted')])
