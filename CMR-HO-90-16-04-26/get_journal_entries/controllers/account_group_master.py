...
class GETAccountGroups(http.Controller):
    ...
    def get_account_groups_data(self, **kwargs):
        ...
        account_group_tally_company_code = [code.strip() for code in account_group_tally_company_code_data.split(',')]
        ag_cleaned_code_str = ",".join(account_group_tally_company_code)
