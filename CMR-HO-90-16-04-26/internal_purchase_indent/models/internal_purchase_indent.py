...
class InternalPurchaseIndent(models.Model):
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if not vals.get('name') or vals.get('name') == 'New':
                vals['name'] = seq.next_by_code('internal.purchase.indent') or 'New'
    ...
    def action_load_po_lines(self):
        ...
        if self.purchase_order_ids:
            domain.append(('order_id', 'in', self.purchase_order_ids.ids))
    ...
    def create_pi_request(self):
        ...
        self.write({
            'approval_request_id' : reuest_id.id,
            'state': 'progress'
                    })
    ...
    def action_cancel(self):
        ...
        self.approval_request_id.request_status = 'cancel'
