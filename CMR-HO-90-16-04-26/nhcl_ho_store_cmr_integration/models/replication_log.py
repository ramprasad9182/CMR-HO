...
class ReplicationLog(models.Model):
    ...
    _description = "Nhcl Replication Log"
...
class OldStoreReplicationLog(models.Model):
    ...
    _description = "Nhcl Old Store Replication Log"
    _order = 'id desc'
...
class TransactionReplicationLog(models.Model):
    ...
    _order = 'id desc'
    _description = "Nhcl Transaction Replication Log"
...
class StoreReplicationLog(models.Model):
    ...
    _description = "Nhcl Store Replication Log"
...
class JobInitiatedStatusLog(models.Model):
    ...
    _order = 'id desc'
    _description = "Nhcl Initiated Status Log"
