...
class AccountMove(models.Model):
    ...
    def create(self, vals_list):
        ...
        elif res and 'invoice_line_ids' in vals_list and 'nhcl_store_je' in vals_list and vals_list['nhcl_store_je'] == True and 'journal_id' in vals_list and vals_list['journal_id.name'] == 'Credit Note Issue':
            res.sudo().action_post()
