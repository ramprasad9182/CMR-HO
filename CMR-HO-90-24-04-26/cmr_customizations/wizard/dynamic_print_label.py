...
class DynamicPrintLabel(models.TransientModel):
    ...
    move_line_ids = fields.Many2many(
        'stock.move.line',
        'dynamic_print_label_move_line_rel',
        'wizard_id',
        'move_line_id',
        string='Move Lines',
    )
    ...
    quantity_labels = fields.Integer(string='Quantity', default=1)

    zpl_preview = fields.Binary(string="Label Preview", readonly=True)
    label_id = fields.Many2one('dynamic.label', string="Label Template")
    ...
    def action_print_label(self):
        ...
        try:
            ...
            raise UserError(f"LAN Printing Failed: {e}")
