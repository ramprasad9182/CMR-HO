...
class BulkProductProduct(models.TransientModel):
    ...
    _description = "Bulk Product Product"
                    ...
                    if line.is_required == 'yes':
                        ...
                        try:
                            ...
                            if k.default_code:
                                ...
                                varient_domain = [
                                    ('nhcl_display_name', '=', k.nhcl_display_name)]
...
class BulkProcessLine(models.TransientModel):
    ...
    _description = "Bulk Process Line"
