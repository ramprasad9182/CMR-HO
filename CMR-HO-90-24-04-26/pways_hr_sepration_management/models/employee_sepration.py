...
class HrEmployee(models.Model):
    ...
    joining_date = fields.Date(string="Join Date", help='Joining date of the employee', related='date_of_joining', store=True)
...
class HrEmployeeSepration(models.Model):
    ...
    _order = 'id desc'
    _description = "Hr Employee Sepration"
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            vals['name'] = seq.next_by_code('hr.employee.sepration') or 'New'
