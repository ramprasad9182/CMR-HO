...
class HrApplicant(models.Model):
    ...
    # is_stage_second_interview = fields.Boolean(
    #     string="Second Interview Stage",
    #     compute="_compute_is_stage_second_interview",
    #     store=False
    # )
    ...
    family_insurance = fields.Float(string="FAMILY INSURANCE (Per Annum)", compute="_compute_family_insurance")
