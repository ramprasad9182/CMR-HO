...
class ProductCategory(models.Model):
    ...
    #
    #     ho_store_id = self.env['nhcl.ho.store.master'].search([('nhcl_store_type', '=', 'ho')])
    ...
    #         print(i.get("nhcl_store_data_id"))
    ...
    #
    #     res.update({'replication_id': replication_data})
    #     return res
    ...
    #     rtn = super(ProductCategory, self).create(values)
    #     self.env['bus.bus']._sendone(
    #         self.env.user.partner_id,
    #         "simple_notification",
    #         {
    #             "title": "Success",
    #             "message": f"New {rtn.name} Category Successfully created.",
    #             "warning": True
    #         })
    #     return rtn

    # def write(self, values):
    #     _logger.info("Category write method vals: %s", values)
    #     rtn = super(ProductCategory, self).write(values)
    #
    #     for record in self:
    #         try:
    #             self.env['bus.bus']._sendone(
    ...
    #                 }
    #             )
    #             _logger.info("Notification sent for %s", record.name)
    ...
    def get_stores_data(self):
        for line in self:
            ...
            for rec in line.replication_id:
                ...
                try:
                    ...
                    try:
                        ...
                        category_list = {
                            ...
                            'total_route_ids': [route.id for route in self.total_route_ids] if self.total_route_ids else False,
    ...
    def update_product_category(self):
        for line in self.replication_id:
            ...
            try:
                ...
                # if not category_id_data:
                #     print("No matching product Category found. Skipping this attribute.")
                #     continue
