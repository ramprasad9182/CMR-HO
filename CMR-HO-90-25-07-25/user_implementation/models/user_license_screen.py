...
class LicenseKey(models.Model):
    ...
    # salesperson_count = fields.Integer(string="Sales Person")
    ...
    #     if vals.get('doc_number', 'New') == 'New' and vals.get('license_count') > 0:
    #         vals['doc_number'] = self.env['ir.sequence'].next_by_code('license.key.generation.seq') or 'New'
    #     return super(LicenseKey, self).create(vals)
    ...
    def action_for_generate_license_key(self):
        ...
        self.state = 'closed'
            ...
            # decrypted_data = zlib.decompress(fernet.decrypt(encrypted_data)).decode()
            # print("============",decrypted_data)


    # def action_for_cancel_state(self):
    #     self.state = 'cancel'
